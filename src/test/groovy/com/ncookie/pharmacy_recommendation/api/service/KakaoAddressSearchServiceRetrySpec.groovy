...
import com.ncookie.pharmacy_recommendation.api.dto.MetaDto
...
class KakaoAddressSearchServiceRetrySpec extends AbstractIntegrationContainerBaseTest {
    ...
    def "requestAddressSearch retry success"() {
        ...
        then:
        2 * kakaoUriBuilderService.buildUriByAddressSearch(inputAddress) >> uri     // 메소드 2번 호출되는지 검증
